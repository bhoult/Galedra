...
refusal named the field's real home (`593732d`), coverage appeared within minutes and reached
**19 of 19** absences in the run's final window — from none at all to all of them, on one
...
### 6. Small things this run turned up
