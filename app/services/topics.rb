...
module Topics
  ...
  CUES = {
    ...
    "economics/markets" => /\b(stock|market|shares|investor|bond|crypto|bitcoin)\w*/i,
    ...
    "law/legislation" => /\b(law|statute|legal|illegal|ban(ned)?|prohibit)\w*/i,
    "history/ancient" => /\b(ancient|bc|bce|pharaoh|roman|greek|babylon|sumer|watchers?|enoch)\w*/i,
    "history/modern" => /\b(19\d\d|20[0-2]\d|century|world war|cold war)\b/i,
