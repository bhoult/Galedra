...
module Tasks
  ...
  module Create
    ...
    def call(task_type:, target:, domain: Audits::Policy.default_domain, required_assignments: 1, location: nil, snapshot_seq: nil, created_by: nil, priority_factor: "1")
      ...
      Task.create!(
        ...
        created_by_contributor_id: created_by&.id, status: "OPEN"
      )
    end
