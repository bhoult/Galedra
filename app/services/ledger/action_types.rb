...
module Ledger
  ...
  module ActionTypes
    ...
    # moderation and governance actions in Stages 4 and 5.
    IMPLEMENTED = (%w[REGISTER_KEY DELEGATE REVOKE_KEY REVOKE_DELEGATION ACCEPT INVALIDATE] + (EPISTEMIC - %w[TASK_RESULT])).freeze
