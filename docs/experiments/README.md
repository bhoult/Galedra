...
- [2026-09-22 — A second vendor's agent connects for the first time](2026-09-22-muse-first-foreign-agent.md) — Meta's Muse: a new identity on every connection, three refusals that described our internals rather than the caller's request, and four well-written rules that changed behaviour none of the 319 times they were served
