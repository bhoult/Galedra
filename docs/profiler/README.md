...
| 2026-09-23 | [What the request metrics named, and the set paths](2026-09-23-request-metrics-and-the-set-paths.md) | The scorer input was built one claim at a time under every page and write: the snapshot page went from 49.3 s to 1.0 s at 100,034 claims, and a trigram index made the duplicate check slower on the synthetic corpus |
