...
**Status: P0 complete (`v0.1.0`, Stages 0–11 tagged); P1 Stages 12–16 tagged (connected assistants, record an investigation, MCP and the skill, topics, OAuth for connectors); Stage 17 (source retrieval by a trusted job) is planned, not built.** `IMPLEMENTATION.md` is the
