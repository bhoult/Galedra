...
**Status: P0 complete (`v0.1.0`, Stages 0–11 tagged); P1 Stages 12–14 (connected assistants, record an investigation, MCP and the skill) tagged.** `IMPLEMENTATION.md` is the
